...
<form class="formoid-default-skyblue" style="background-color:#e0e0e0;font-size:14px;font-family:'Open Sans','Helvetica Neue','Helvetica',Arial,Verdana,sans-serif;color:#666666;max-width:650px;min-width:150px" method="post"><div class="title"><h2>Contact Our Office</h2></div>
