...
<form class="formoid-default-skyblue" style="font-size: 14px; font-family: 'Open Sans','Helvetica Neue','Helvetica',Arial,Verdana,sans-serif; color: #373737; max-width: 800px; min-width: 150px; padding: 5px;" method="post"><div class="title"><h2></h2></div>
  ...
  <label class="title">Opposing party's name</label><textarea name="textarea" cols="20" rows="1" maxlength="200" class="medium" ></textarea></div>
  <div class="element-textarea<?frmd_add_class("textarea")?>">
  <label class="title">Please provide brief description (optional)</label><textarea name="textarea" cols="20" rows="5" maxlength="200" class="medium" ></textarea></div>
