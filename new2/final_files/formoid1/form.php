...
define('EMAIL_FOR_REPORTS', 'into@andruckilaw.com');
define('RECAPTCHA_PRIVATE_KEY', '6LdO5u8SAAAAAEFfDMqHe6lSHDg9tvj43WA36YEx');
define('FINISH_URI', 'http://andruckilaw.com/new2/thankyou2.html');
...
<form class="formoid-flat-black" style="background-color: #F3F3F3; font-size: 14px; font-family: 'Lato', sans-serif; color: #666666; max-width: 650px; min-width: 150px" method="post"><div class="title"><h2>Contact Our Office</h2></div>
