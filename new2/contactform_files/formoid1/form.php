...
<form class="formoid-flat-black" style="font-size:14px;font-family:'Lato', sans-serif;color:#666666;max-width:650px;min-width:150px" method="post"><div class="title"><h2>Contact Our Office</h2></div>
	...
	<div class="element-select<?frmd_add_class("select")?>"><label class="title">Please select<span class="required">*</span></label><div class="large"><span><select name="select" required>
