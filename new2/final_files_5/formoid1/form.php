...
<form class="formoid-default-skyblue" style="background-color:#EEEEEE;font-size:14px;font-family:'Open Sans','Helvetica Neue','Helvetica',Arial,Verdana,sans-serif;color:#666666;max-width:650px;min-width:150px" method="post"><div class="title"><h2></h2></div>
	...
	<div class="element-select<?frmd_add_class("select")?>">
	  <label class="title">Type of Inquiry<span class="required">*</span></label><div class="large"><span><select name="select" required>
		...
		<option value="Other">Other (please explain below)</option></select><i></i></span></div></div>
	<div class="element-textarea<?frmd_add_class("textarea")?>">
	  <label class="title">If inquiry selection is 'Other', please provide brief description (optional)</label><textarea name="textarea" cols="20" rows="2" maxlength="100" class="medium" ></textarea></div>
	<div style="margin-top:10px;margin-bottom:10px;"><strong>Please supply the following information so that we may complete a conflict check prior to responding to your inquiry:</strong></div>
	...
	<div class="element-radio<?frmd_add_class("radio1")?>"><label class="title">Minor Child(ren) Involved</label>		<div class="column column2"><label><input type="radio" name="radio1" value="Yes" /><span>Yes</span></label></div><span class="clearfix"></span>
