...
<script type="text/javascript">
P7_opTTM('id:p7Tooltip_1','att:title','p7TTM04',8,400,10,1,1,0,0,1,300,0,1,1,0,0,0,0);
</script>
...
<div class="content-wrapper">
          ...
          <div class="p7ap3-col-wrapper multi-columns">
            ...
            <div class="p7ap3-column width-33">
              <div class="p7ap3-column-content border-left p7ehc-6">
               ...
               <div class="p-lead">Mara R. King</div>  <p>Mara HunterMara R. King, an associate at Andrucki &amp; Associates, holds a B.A. degree from Wheaton College in Massachusetts and received her J.D. from the University Of Maine School Of Law...<br>
           ...
           <div class="p-lead">Elyse B. Segovias</div> 
                <p>Elyse SegoviasElyse joined Andrucki &amp; Associates in 2011. Prior to working at Andrucki &amp; Associates, she practiced on her own in York and Cumberland Counties in the areas of Family Law, Juvenile Defense and Child Protection...<br>
  ...
  <p>&nbsp;</p>
    ...
    <div class="sidebar">
      <div class="content p7ehc-1">
        <h2 class="p7TTM_trg" id="p7Tooltip_1" title="Disclaimer: Any communication with us in our capacity as attornies, whether by e-mail or by other means, does not create an attorney-client relationship and is therefore not privileged until the client and the attorney have agreed upon legal representation.For this reason, do not send confidential information to us without first directly communicating with us about the attorney-client relationship. If you agree with these terms, please click fill out the form below.">Contact Our Office</h2>
...
<input name="Contact_Name" type="text" class="inputjoin" id="Contact_Name" placeholder="Full Name" value="<?php echo(ValidatedField("contact","Contact_Name")) ?>" size="" />
...
?>
          ...
          <tr>
            <td valign="top"><span class="foodtable">Phone</span><br><input name="Phone" type="text" class="inputjoin" id="phone" placeholder="Phone number" size="" /></td>
            </tr>
          <tr>
            <td valign="top"><span class="foodtable">Email</span>
              <br>
              <input name="Email_address" type="text" class="inputjoin" id="Email_address" placeholder="Email Address" value="<?php echo(ValidatedField("contact","Email_address")) ?>" />
...
?>
            ...
            <td valign="top"><span class="foodtable">How may we help?</span>
              <br>
...
?>
          ...
          <tr>
            ...
            <br  />
              <input name="Security_code" type="text" class="inputValue" id="Security_code" placeholder="Enter security code" maxlength="30" />
              <br />
              <?php
if (ValidatedField("contact","contact"))  {
...
?>
          ...
          <tr>
            <td><input name="button" type="submit" class="inputButton btn" id="button" /></td>
            </tr>
        </table>
      </div></form>
          <p>&nbsp;</p>
