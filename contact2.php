<?php $form_path='contactform_files/formoid1/form.php'; require_once $form_path; ?><!doctype html>
<html><!-- InstanceBegin template="/Templates/andruckilaw-final.dwt" codeOutsideHTMLIsLocked="false" --><head>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0, minimum-scale=1.0" />
<!-- InstanceBeginEditable name="doctitle" -->
<title>Andrucki &amp; Associates | Contact</title>
<!-- InstanceEndEditable -->
...
<!-- InstanceBeginEditable name="miscscripts" -->miscscripts<!-- InstanceEndEditable -->
  ...
  <div class="columns-wrapper">
   ...
   <div class="main-content"><!-- InstanceBeginEditable name="left-content" -->
      <div class="content p7ehc-1">
        ...
        <p>Disclaimer:<br>
          Communications to me in my capacity as an attorney, whether by e-mail or by other means, do not create an attorney-client relationship and are therefore not privileged until the client and the attorney have agreed upon legal representation.<br>
        ...
        Contacting my office indicates that you agree with these terms.</p>
      </div>
